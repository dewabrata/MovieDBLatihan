package com.juara.moviedblatihan.service;
...
public interface APIInterfacesRest {
    @FormUrlEncoded
    @POST("moviedb/add")
    Call<SuccessPost> addMovieDB(@Field("judul") String judul, @Field("rating") String rating, @Field("genre") String genre, @Field("directedby") String directedby, @Field("writenby") String writenby, @Field("intheater") String intheater, @Field("studio") String studio);
/*
    @GET("weather")
